...
print("*" * 20)
print("*" * 20)
print("loading_jupyter_server_extension: jupyter-askdata. First install will download universal-sentence-encoder, please wait...")
print("*" * 20)
print("*" * 20)
CG = CodeGenerator()


class JupyterAskdataHandler(IPythonHandler):
    def __init__(self, application, request, **kwargs):
        super(JupyterAskdataHandler, self).__init__(application, request, **kwargs)
...
def load_jupyter_server_extension(nb_server_app):
    ...
    host_pattern = '.*$'
    route_pattern = url_path_join(web_app.settings['base_url'], '/jupyter-askdata')
    web_app.add_handlers(host_pattern, [(route_pattern, JupyterAskdataHandler)])
    print("loaded_jupyter_server_extension: jupyter-askdata")
